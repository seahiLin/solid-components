...
function getQueryString(key: any) {
...
const SheetConfig: any = {
  ...
  gridKey: '1',
  allowUpdate: true,
  loadUrl: 'https://centerdev4.starride.cn/csc-web/onlineForm/load?',
  updateUrl: `ws://10.42.116.149:10870/csc-web/coop/1/${getQueryString('id')}`,
  // data: [
  //   {
  //     name: "需求表", //工作表名称
  //     color: "", //工作表颜色
...
const Sheet: Component<{
  ...
  return <div id="sheet" class={styles.sheet} />;
};
